...
function done(ctx) {
    return __awaiter(this, void 0, void 0, function () {
        var data, jsonArray, i, movie, aIOTitle, aioShortUrl, appIndex, appInstance;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    aioShortUrl = movie.aioShortUrl;
                    appIndex = i % apps.length;
                    appInstance = apps[appIndex];
                    return [4 /*yield*/, sendToCOllection2(-1002241224255, aioShortUrl, aIOTitle || "none", appInstance)];
                case 3:
                    _a.sent();
