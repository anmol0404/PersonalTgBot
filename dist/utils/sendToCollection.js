...
export function sendToCOllection2(chat, link, caption, app) {
    return __awaiter(this, void 0, void 0, function () {
        var error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, app.telegram.sendMessage(chat, "```\n".concat(caption, "\n```") || "", {
                            parse_mode: "Markdown",
                            reply_markup: keyboard.makeCollectionButton(link),
                        })];
                case 1:
                ...
                case 2:
                    error_2 = _a.sent();
                    console.error("Error sending msg:", error_2);
                    return [3 /*break*/, 3];
                case 3: return [2 /*return*/];
            }
        });
...
export function sendToCollectionAll(chat, link, caption, aIOPosterID, app, backup) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, app.telegram.sendPhoto(chat, aIOPosterID || "", {
...
export function sendToCollectionPosterIndex(chat, link, caption, aIOPosterID, app) {
    return __awaiter(this, void 0, void 0, function () {
        var error_4;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, app.telegram.sendMessage(chat, caption.trim() || "", {
                            parse_mode: "Markdown",
                ...
                case 2:
                    error_4 = _a.sent();
                    console.error("Error sending msg:", error_4);
                    return [3 /*break*/, 3];
                case 3: return [2 /*return*/];
            }
        });
