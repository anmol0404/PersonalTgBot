...
export var makeButtons = function (link, next, prev) {
    return {
        inline_keyboard: [
            ...
            [{ text: "❣️ Join Back-UP ❣️", url: "".concat(env.backup) }],
        ],
    };
};
export var makeCollectionButton = function (link, backup) {
    if (backup === void 0) { backup = env.backup; }
    return {
        inline_keyboard: [
            [{ text: "Download", url: link }],
            [{ text: "Join Back-Up", url: "".concat(env.backup) }],
        ],
    };
};
